    ...
    //    if room is not craete
        ...
        socket.on( 'connect', () => {
            ...
            socket.on( 'new user', ( data ) => {
                ...
                // testing for new user add to system 
                // console.log(data);
            
                pc.push( data.socketId );
                // name.push( data.sender );
                // console.log(data.sender);
                init( true, data.socketId,username);
            ...
            socket.on( 'newUserStart', ( data ) => {
                ...
                // console.log(data.sender)
                init( false, data.sender,username);
            ...
            pc[partnerName].ontrack = ( e ) => {
                ...
                if ( document.getElementById( `${ partnerName }-video` ) ) {
                    ...
                    controlDiv.innerHTML = `<i class="fa fa-microphone text-white pr-3 mute-remote-mic" title="Mute"></i>
                        <i class="fa fa-expand text-white expand-remote-video" title="Expand"></i><p style="color:white;">`+name+`</p>`;
        ...
        //When user choose to record own video as
